...
export default function AboutPage() {
  ...
  return (
    <section>
      ...
      <section className="grid grid-cols-[1fr_1fr] gap-4 my-8" style={{ width: "80%", margin: "2em auto" }}>
        <section>
        ...
        {/* <Image src={"https://res.cloudinary.com/ddgmru7d1/image/upload/v1756299859/chicken_01_dll8od.jpg"} alt="chicken_one" className="object-cover rounded-3xl shadow-2xl mt-12" width={500} height={500} /> */}
        <img
          src="https://res.cloudinary.com/ddgmru7d1/image/upload/v1756299859/chicken_01_dll8od.jpg"
          alt="chicken_one"
          className="object-cover rounded-3xl shadow-2xl mt-12 w-full h-auto"
        />
      </section>
      ...
      <section className="bg-gray-100 my-8" >
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1em 2em", padding: "0em 4em 2em", }}>
          {
            timeline.map((entry, id) => (
              <div key={id} style={{ border: "1px solid lightgrey", padding: "1em", borderRadius: "1em", backgroundColor: "white" }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1em", padding: "2em", }}>
        {
      ...
      <section className="bg-gray-100 my-8" >
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1em 2em", padding: "0em 4em 2em", }}>
          {
